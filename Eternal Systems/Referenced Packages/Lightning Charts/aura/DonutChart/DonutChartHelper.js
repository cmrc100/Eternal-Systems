    ...
    parseDataFromDataSource: function(component, dataSourceType, jsonData) {
   	...
   	displayChart: function(component, jsData) {
    	if (jsData != "") {
            ...
            var xOffsetForLegend = -270;
            
            if (categoryCount > 3) 
                xOffsetForLegend = -240;
                
            if (categoryCount > 6) 
                xOffsetForLegend = -180;
        ...
        /*
        var chart = $j("#" + uiControlId).data("kendoChart");
        chart.options.chartArea.height = parseInt(chartHeight);
        console.log("set height");
        chart.options.chartArea.width = parseInt(chartWidth);
        console.log("set hwidth");
        chart.redraw();
        console.log("set height and width completion");
        */
        /*
			chart.setOptions({ chartArea: {
	                    height: chartHeight,
                        width:chartWidth
          			} });
                    */
