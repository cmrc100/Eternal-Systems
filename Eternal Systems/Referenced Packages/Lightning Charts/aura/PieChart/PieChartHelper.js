({
    ...
    createChart : function(jsonData, component, dataSourceType) {
        ...
        var self = this;
	    //console.log("PieChart:  createChart: component id " + component.get("v.docmId") + " " + jsonData);
    ...
    parseDataFromDataSource: function(component, dataSourceType, jsonData) {
   	...
   	displayChart: function(component, jsData) {
    	if (jsData != "") {
    		...
    		chartData += "]";
        	//console.log("PieChart:  displayChart: component id " + component.get("v.docmId") + " chartData " + chartData);
            ...
            chartData = "[{\"type\": \"pie\", \"startAngle\": 150, \"data\": " + chartData + "}]";
